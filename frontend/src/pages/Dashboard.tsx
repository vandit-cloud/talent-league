...
import { Brain, FileText, Award, BarChart3, Users, TrendingUp, Sparkles, Zap, Target, Rocket, ChevronRight } from 'lucide-react';
...
export function Dashboard() {
  ...
  const quickActions = [
    ...
    },
    {
      ...
      description: 'AI-proctored technical evaluation',
      icon: Award,
  ...
  const stats = [
    { label: 'Assessments', value: '0', icon: Award, gradient: 'from-violet-500 to-purple-600', trend: '+12%' },
    { label: 'Resume Score', value: '--', icon: FileText, gradient: 'from-blue-500 to-indigo-600', trend: 'New' },
    { label: 'Job Matches', value: '0', icon: Users, gradient: 'from-emerald-500 to-teal-600', trend: '+5' },
    { label: 'Success Rate', value: '--', icon: TrendingUp, gradient: 'from-orange-500 to-pink-600', trend: 'N/A' }
  ];

  const features = [
    { icon: Zap, title: 'AI-Powered', desc: 'Smart analysis' },
    { icon: Target, title: 'Precision', desc: 'Accurate matching' },
    { icon: Rocket, title: 'Fast Track', desc: 'Quick results' },
    { icon: Sparkles, title: 'Pro Features', desc: 'Premium tools' }
  ];
          ...
          <div className="glass-card rounded-2xl p-8 relative overflow-hidden">
            ...
            <div className="relative flex items-center justify-between">
              <div>
                ...
                <p className="mt-2 text-gray-600 text-lg">Your AI-powered career development platform</p>
              </div>
            ...
            {stats.map((stat, index) => {
              ...
              return (
                <div key={index} className="group relative">
                  <div className={`absolute inset-0 bg-gradient-to-r ${stat.gradient} rounded-2xl blur-lg opacity-0 transition-opacity duration-300 group-hover:opacity-30`}></div>
        ...
        <div className="px-4 sm:px-0">
          ...
          <div className="glass-card rounded-2xl p-8">
            <div className="text-center py-12">
              ...
              <p className="text-gray-500 mb-6 max-w-md mx-auto">Start your journey by uploading your resume or taking an AI-powered assessment</p>
